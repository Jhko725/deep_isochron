...
class AffineCouplingFlow(eqx.Module):  # TODO: create AbstractINN interface
    dim: int
    split_idx: int
    flip: bool
    ...
    def invert(self, y: Float[Array, " dim"]) -> Float[Array, " dim"]:
...
class ResidualCouplingFlow(
    eqx.Module
):  # TODO: support custom s, t in AffineCouplingFlow, and make this a subclass or so.
    split_idx: int
    flip: bool
